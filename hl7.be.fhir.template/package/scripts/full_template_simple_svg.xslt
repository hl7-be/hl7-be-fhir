...
<!--															<xsl:value-of select="unparsed-text('../../images/examplescenario-usecase1.svg')" disable-output-escaping="yes" />
-->
															<xsl:copy-of select="document('../../images/examplescenario-usecase1.svg')"/>
